...
| Pfad | Inhalt | Tests |
|---|---|---|
| `packages/action_combat` | die Grube: 30 Stufen, 5 Gegnerarten, 19 Fähigkeiten, 8 Waffen, Sets und legendäre Kräfte | 121 |
...
| `lib/` | Flutter-App: Start, Skillbaum, Tracker, Grube, Laden, Charakter, Errungenschaften | 412 |
